function Sort() {
  return (
    <svg
      ...
      x="0px"
      y="0px"
      viewBox="0 0 384.964 384.964"
    >
      <g>
        <g id="Double_Arrow_Up_x2F_Down">
          <path
            d="M333.285,86.501L249.096,3.492c-4.68-4.632-12.512-4.68-17.191,0l-84.2,83.009c-4.752,4.704-4.74,12.319,0,17.011
          ...
          />
          <path
            d="M220.079,281.464l-63.46,62.558V156.433c0-6.641-5.438-12.03-12.151-12.03c-6.713,0-12.151,5.39-12.151,12.03v187.589
